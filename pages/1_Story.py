...
st.header("New: What weather type shows up most?")
st.write("This is a simple count of each weather label in the dataset.")
st.altair_chart(chart_static_weather_counts(df), use_container_width=True)
st.caption("Takeaway: some weather types happen much more often than others.")
